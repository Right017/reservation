...
<body>
    ...
    <!-- Cards are start here -->
    <div class="container">



        <h1>Hi Foodie, What's your pick?</h1>
        <hr>
        <div class="row">
        ...
        <!-- Cards are finished here -->
<br><br><br>
        <!-- Resturent start here -->

        <h1>Highly recommended restaurants</h1><hr>
        <div class="card" style="width: 18rem;">
            <a href="#"><img src="img/4.jpg" class="card-img-top" alt="..."></a>
            <div class="card-body">
                <h2 class="card-title">Hungry</h2><hr>
                <p class="card-text">Gandevi Road,Billimora</p>
            </div>
        </div>
        <!-- Resturent end here -->
